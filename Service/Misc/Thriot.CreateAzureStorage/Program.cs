...
namespace Thriot.CreateAzureStorage
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CreateSettingIfNotExist(settingRepository, Setting.TelemetrySetupServiceEndpoint, "http://localhost:8001/v1/telemetryDataSinkSetup");
            CreateSettingIfNotExist(settingRepository, Setting.TelemetrySetupServiceApiKey, Crypto.GenerateSafeRandomToken());
            CreateSettingIfNotExist(settingRepository, Setting.MessagingServiceEndpoint, "http://localhost:8003/v1/messaging");
            ...
            CreateSettingIfNotExist(settingRepository, Setting.WebsiteUrl, "http://localhost:7999");
            CreateSettingIfNotExist(settingRepository, Setting.ManagementApiUrl, "http://localhost:8000/v1");
            CreateSettingIfNotExist(settingRepository, Setting.PlatformApiUrl, "http://localhost:8001/v1");
            CreateSettingIfNotExist(settingRepository, Setting.PlatformWsUrl, "ws://localhost:8080");
            CreateSettingIfNotExist(settingRepository, Setting.ReportingApiUrl, "http://localhost:8002/v1");
