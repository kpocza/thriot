...
{
    public abstract class ServiceOperationsTestBase
    {
        public virtual void CreateServiceTest()
        {
        ...
        public virtual void GetServiceTest()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
            var serviceOperations = environmentFactory.MgmtServiceOperations;
        ...
        public virtual void ListServicesTest()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
        ...
        public virtual void DeleteServiceTest()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
            var companyOperations = environmentFactory.MgmtCompanyOperations;
            var serviceOperations = environmentFactory.MgmtServiceOperations;
        ...
        public virtual void UpdateServiceTest()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
            var companyOperations = environmentFactory.MgmtCompanyOperations;
            var serviceOperations = environmentFactory.MgmtServiceOperations;
        ...
        public virtual void UpdateService2Test()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
            var serviceOperations = environmentFactory.MgmtServiceOperations;
