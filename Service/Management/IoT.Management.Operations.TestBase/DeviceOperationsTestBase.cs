...
{
    public abstract class DeviceOperationsTestBase
    {
        public virtual void CreateDeviceTest()
        {
        ...
        public virtual void GetDeviceTest()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
            var deviceOperations = environmentFactory.MgmtDeviceOperations;
        ...
        public virtual void ListDevicesTest()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
            var deviceOperations = environmentFactory.MgmtDeviceOperations;
        ...
        public virtual void DeleteDeviceTest()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
            var deviceOperations = environmentFactory.MgmtDeviceOperations;
            var networkOperations = environmentFactory.MgmtNetworkOperations;
        ...
        public virtual void UpdateDeviceTest()
        {
            var environmentFactory = SingleContainer.Instance.Resolve<IEnvironmentFactory>();
            var deviceOperations = environmentFactory.MgmtDeviceOperations;
            var networkOperations = environmentFactory.MgmtNetworkOperations;
